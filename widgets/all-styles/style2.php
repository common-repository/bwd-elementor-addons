    ...
    if($woocptmln_all_products->have_posts()):
        while ( $woocptmln_all_products->have_posts() ) : $woocptmln_all_products->the_post();
            ...
            <div class="woocptmln-box woocptmln-timeline-item woocptmln-timeline-for-content woocptmln-timeline-box-bgc-cmmn">
                <?php 
                $wooiap_title_link_check = ('yes' === $woocptmln_title_link)?'<a href="'.esc_url(get_the_permalink()).'">'.esc_html($product->name).'</a>':esc_html($product->name);
                ...
                // ======================= Texo
                // Cat
                $woocptmln_url = plugin_dir_url( '../../category/'.get_cat_ID(get_the_category()));
                ...
                echo ('yes' === $woocptmln_sale)?wp_kses_post($woocptmln_sale_wrap):'';
                ...
                // =======================
                echo ('yes' === $woocptmln_wrapper)?'<a href="'.esc_url(get_the_permalink()).'" class="woocptmln-timeline-img">'.wp_kses_post($product->get_image()).'</a>':'<div class="woocptmln-timeline-img">'.wp_kses_post($product->get_image()).'</div>';
                ?>
