          ...
          echo '<div class="d-flexx align-items-center justify-content-center width-100 height-100">';
            echo '<div class="teps-postslider-content-info teps-slide-content '.esc_attr($animation_class).'">';
              echo '<div class="d-flex align-items-center teps-extra-align teps-flex-wrap1">';
                ...
                echo '<img src="'.esc_url($teps_the_thumbnail_check).'">';
              ...
              echo '<div class="teps-postslider-button">';
                ...
                if('icon' === $teps_button_types){ echo '<i class="teps_icons '.esc_attr($settings['teps_blog_button_icon']['value']).'"></i>'; } elseif('text_icon' === $teps_button_types){
