...
?>
<div class="bwdcp_catagory_2 bwdcp-slider-common <?php echo esc_attr($settings['bwdcp_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdcp-catproduct-custom-id'] ); ?>">
